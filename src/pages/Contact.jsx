...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_iw5hv2e', 'template_k0ku8ke', form.current, 'WJMXcogEeqnfCUxGn')
        .then((result) => {
                ...
                <div className="container-sample">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-[66.66%_32%] tablet:grid-cols-1 mobile:grid-cols-1 gap-3 tablet:gap-4 mobile:gap-4">
                            ...
                            <div className=''>
                                <form ref={form} onSubmit={sendEmail} className="bg-[#09101a] px-[40px] pb-[40px]" action="">

                                    <div className="grid grid-cols-2 mobile:grid-cols-1">
                                        <div>
                                            <label></label>
                                            <input required placeholder="Your Name" className="form-input" type="text" name="user_name" />
                                        </div>
                                        <div>
                                            <label></label>
                                            <input required placeholder="Your Email" className="form-input" type="email" name="user_email" />
                                        </div>
                                    ...
                                    <div className="grid grid-cols-2 mobile:grid-cols-1">
                                        <div>
                                            <label></label>
                                            <input placeholder="Phone Number" className="form-input" type="tel" name="user_number" />
                                        </div>
                                        <div>
                                            <label></label>
                                            <input placeholder="Your Website" className="form-input" type="text" name="user_website" />
                                        </div>
                                    </div>
                                    <div className="grid">
                                        <div>
                                            <label></label>
                                            <textarea cols={10} rows={5} placeholder="Message" className="form-textarea" type="text" name="message" />

                                            <input className="form-submit" type="submit" value="submit now" />
                                        </div>
                                    </div>
                                ...
                                <div className="w-full h-full">
                                    <div className="mapouter relative text-center max-w-full h-[571px] tablet:h-[400px] mobile:h-[300px]">
                                        <div className="gmap_canvas overflow-hidden bg-none max-w-full h-[571px] tablet:h-[400px] mobile:h-[300px]">
                                            <iframe className="gmap_iframe max-w-full h-[571px] tablet:h-[400px] mobile:h-[300px]" width="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=526&amp;height=571&amp;hl=en&amp;q=10 olalekan street oke ira&amp;t=&amp;z=10&amp;ie=UTF8&amp;iwloc=B&amp;output=embed">
                                            </iframe>
                            ...
                            <div>
                                <form className='relative' action="">
                                    ...
                                    <span className='relative'>
                                        <input size={40} placeholder='Enter your Email' className='w-full border outline-none text-[16px] font-medium bg-[#131313] border-solid border-[#55e6a5] text-white py-[27px] px-[25px]' type="email" />
                                    </span>
                                    <input  className='notify-btn' value="Notify Now" type="submit" />
